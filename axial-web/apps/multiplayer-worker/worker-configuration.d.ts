/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 431861c4f36793df628929360c677491)
// Runtime types generated with workerd@1.20260617.1 2026-06-18 nodejs_compat
interface __BaseEnv_Env {
	PUBLIC_WEB_ORIGIN: "https://playaxial.dev";
	ALLOWED_ORIGINS: "https://playaxial.dev,http://localhost:4173,http://localhost:5173,http://localhost:5174,http://localhost:5175,http://localhost:5176,http://127.0.0.1:4173,http://127.0.0.1:5173,http://127.0.0.1:5174,http://127.0.0.1:5175,http://127.0.0.1:5176";
	AXIAL_ROOM: DurableObjectNamespace<import("./src/index").RoomObject>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_WEB_ORIGIN" | "ALLOWED_ORIGINS">> {}
}
